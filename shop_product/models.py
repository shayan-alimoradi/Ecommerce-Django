...
class Product(TimeStamp):
    ...
    visit_count = models.ManyToManyField(
        IPAddress, blank=True, related_name="visit_count"
    )
...
class Variant(TimeStamp):
    title = models.CharField(max_length=177)
    product_variant = models.ForeignKey(Product, on_delete=models.PROTECT, null=True)
